...
def padlock_heuristic_selection(
    oligos, oligos_scores, overlapping_matrix, n_oligo, n_trials=10000
):
    ...
    :param oligos: dictionary with all the oligos
    :type oligos: dict
    ...
    return oligos, oligos_scores, best_set
