...
- ScrinshotProbeDesigner: This class automates the creation of probes for the SCRINSHOT (Single-Cell Resolution IN Situ Hybridization On Tissues) protocol, ensuring high specificity and efficiency of probes.
"""
