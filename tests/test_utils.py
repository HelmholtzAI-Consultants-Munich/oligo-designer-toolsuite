...
#     """Test of Fasta parser parses file correctly."""
#     parser = FastaParser()
#     file_fasta = "data/annotations/custom_GCF_000001405.40_GRCh38.p14_genomic_chr16.fna"

#     dataframe_fasta = parser.read_fasta(file_fasta, target_lines=10)
#     assert dataframe_fasta.shape[1] == 2, "error: Fasta dataframe not correctly loaded"
