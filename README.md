...
In the first step, install the additional dependencies and in the second step, install ***Oligo Designer Toolsuite*** itself.
...
**🖥️ Linux and MacOS M Chip (arm64) Requirements**
...
**🖥️ ⚠️ DEPRECATED ⚠️ MacOS Intel Chip (osx64) Requirements**

This option is not actively supported anymore.
